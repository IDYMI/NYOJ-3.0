...
public class RankController {
    ...
    public CommonResult<Void> getUserCodeRecord(@RequestBody Map<String, Object> params) {
        return rankService.getUserCodeRecord((List<String>) params.get("uidList"), (String) params.get("startTime"), (String) params.get("endTime"));
    }
}