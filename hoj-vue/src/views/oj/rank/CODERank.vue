...
export default {
  ...
  data() {
    return {
      ...
      screenWidth: 768,
      columns: [
        { title: "m.Submit_Count", field: "nyojAc" },
        { title: "m.Blank_Lines", field: "codeforcesAc" },
        { title: "m.Comment_Lines", field: "nowcoderAc" },
        { title: "m.Code_Lines", field: "vjudgeAc" },
        { title: "m.Cloc_length", field: "pojAc" },
      ],
    };
  },
  created() {
  ...
  methods: {
    getRankData(page) {
      //test 获取用户时间段内的代码量
      let data = {
        uidList: ["48d8792b425c40e39d616cac56ac33a6"],
        startTime: "2022-07-19T16:00:00.000Z",
        endTime: null,
      };
