export const m = {
  ...
  CODE_Ranklist: 'Ten Thousand Lines Initiative',
  ...
  Action_Invent: 'Invented to Mine',
  ...
  Group_Proposition_Tips: 'Proposition - Invitation required for joining',
  ...
  // /views/oj/message/UserInvent.vue
  Accept: 'Accept',
  Refuse: 'Refuse',
  isAcceptMsg: 'Successfully joined the team !',
  isRefuseMsg: 'Refused to join the team.',

  // /views/oj/contest/children/ContestAdminSign.vue
  Sign_Status: 'Status',
  Sign_Accept: 'Accept',
  ...
  Delete_Invent: 'Delete Invent',
  Invent_msg: 'Invent Msg',
  Participant_: 'Participant',
  Captain: 'Captain',
  Participant_Realname: 'Realname',
  Participant_School: 'School',
  Participant_Course: 'Course',
  Participant_Number: 'Number',
  Participant_ClothesSize: 'ClothesSize',
  Participant_PhoneNumber: 'Phone',
  ...
  // /components/oj/setting/Race.vue
  Real_Info: 'Real Info',
  Race_Info: 'Race Info',
  Course: 'Course',
  Clothes_Size: 'Clothes Size',
  Phone_Number: 'Phone Number',
  RealName_Check_length: 'The length is between 2 and 6 Chinese characters',
  RealName_Check_Required: 'The real name is required.',
  School_Check_length: 'The length is between 2 and 15 Chinese or digit characters (must contains Chinese)',
  Course_Check_Required: 'The course is required.',
  Course_Check_length: 'The length is between 5 and 20 characters (The format should be “09-计科一班”)',
  PhoneNumber_Check_length: 'The phone number that is 11 digits long and in the correct format',
  PhoneNumber_Check_Required: 'The PhoneNumber is required.',
