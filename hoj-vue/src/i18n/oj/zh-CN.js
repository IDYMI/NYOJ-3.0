export const m = {
  ...
  Plagiarism_Time: '时间',
  Plagiarism_LanguageList: '语言列表',
  Plagiarism_ProblemList: '题目列表',
  Add_Moss: '提交查重',
  ...
  Group_Proposition_Tips: '命题团队 - 需要邀请码才能加入',
  ...
  Participant_: '队员',
  Captain: '队长',
  Participant_Realname: '真实姓名',
  Participant_School: '学校',
  Participant_Course: '专业/班级',
  Participant_Number: '学号',
  Participant_ClothesSize: '衣服尺寸',
  Participant_PhoneNumber: '电话',
  Participant_Username: '用户名',
  ...
  Clothes_Size: '参赛衣服尺寸',
  Phone_Number: '联系方式',
  RealName_Check_length: '长度在 2 到 6 个中文字符',
  RealName_Check_Required: '真实姓名不能为空',
  School_Check_length: '长度在 2 到 15 个中文字符和数字（必须包含中文）',
  Course_Check_Required: '专业/班级不能为空',
  Course_Check_length: '长度在在 5 到 20 位（格式为 “09-计科一班” ）',
  PhoneNumber_Check_length: '长度为 11 位且格式正确的电话号码',
  PhoneNumber_Check_Required: '电话不能为空',
  ClothesSize_Check_length: '长度在 1 到 2 位的指定尺码',
